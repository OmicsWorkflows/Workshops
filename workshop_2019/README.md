...
In the <b>practical part</b> the participants had hands-on experience with the KNIME environment (we were using version 3.7.2a), they tried to build their own workflow and then to process the model data using workflow for initial processing of label-free quantitative proteomics data.
